...
function loadDataTable() {
    datatable = $('#table_insumos').DataTable({
        language: {
        ...
        columns: [
            {
                ...
                render: function (data) {
                    return `
                        <a href="/Insumos/Edit/${data}" class="btn btn-sm btn-success text-white" style="cursor:pointer;">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                        <a href="/Insumos/Detail/${data}" class="btn btn-sm btn-info text-white" style="cursor:pointer;">
                            <i class="bi bi-list-task"></i>
                        </a>
                        <a onclick=Delete("/Insumos/Delete/${data}") class="btn btn-sm btn-danger text-white" style="cursor:pointer;">
            ...
            { data: "unidad_Medida", width: "10%", className: "text-center" },
