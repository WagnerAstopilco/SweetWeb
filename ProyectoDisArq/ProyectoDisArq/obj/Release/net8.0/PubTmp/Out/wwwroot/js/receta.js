...
function loadDataTable() {
    datatable = $('#table_recetas').DataTable({
        language: {
        ...
        columns: [
            {
                ...
                render: function (data) {
                    return `
                        <a href="/Recetas/Edit/${data}" class="btn btn-sm btn-success text-white" style="cursor:pointer;">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                        <a href="/Recetas/Detail/${data}" class="btn btn-sm btn-info text-white" style="cursor:pointer;">
                            <i class="bi bi-list-task"></i>
                        </a>
                        <a onclick=Delete("/Recetas/Delete/${data}") class="btn btn-sm btn-danger text-white" style="cursor:pointer;">
            ...
            //{ data: "preparacion", width: "30%", className: "text-center" },
        ]
    });
}
