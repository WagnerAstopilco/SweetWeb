...
function loadDataTable() {
    datatable = $('#table_pedidos').DataTable({
        language: {
        ...
        columns: [
            {
                ...
                render: function (data) {
                    return `
                        <a href="/Pedidos/Edit/${data}" class="btn btn-sm btn-success text-white" style="cursor:pointer;">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                        <a href="/Pedidos/Detail/${data}" class="btn btn-sm btn-info text-white" style="cursor:pointer;">
                            <i class="bi bi-list-task"></i>
                        </a>
                        <a onclick=Delete("/Pedidos/Delete/${data}") class="btn btn-sm btn-danger text-white" style="cursor:pointer;">
                            <i class="bi bi-trash3-fill"></i>
                        </a>
                    `;
                }, width: "20%", orderable: false, searchable: false, className: "text-center"
            },
            { data: "dni_titular", className: "text-center" },
